...
def comments_new():
    ...
    comment = {
        ...
        'comment_id': ObjectId(request.form.get('comment_id'))
    }
    print(comment)
    comment_id = comments.insert_one(comment).inserted_id
    return redirect(url_for('videogame_show', comment_id=request.form.get('comment_id')))
...
def comments_delete(comment_id):
    ...
    return redirect(url_for('videogame_show', comment_id=comment.get('comment_id')))
